...
namespace NETMapnik
{
	...
	//template void grid_encode_utf<mapnik::grid>(mapnik::grid const&,
	//						System::Collections::Generic::Dictionary<System::String^, System::Object^>^,
	//						bool,
	//						unsigned int);

	template System::Collections::Generic::Dictionary<System::String^, System::Object^>^ grid_encode<mapnik::grid>( 
						mapnik::grid const&, 
						std::string const&, 
						bool, 
						unsigned int);
